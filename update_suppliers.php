<?php 
    ...
    $id=$_GET['id'];
    //$id = $_SESSION['id'];
    $result=mysqli_query($conn, "SELECT * FROM tb_supplier where id='$id' limit 1");
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        ...
                        <p class="text-subtitle text-muted">For user to update supplier</p>
                    </div>
            ...
            <section class="section">
                <div class="card">
                    <form class="form form-vertical" action="" method="POST">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name"
                                            ...
                                            placeholder="Input Name Supplier" value="<?php echo $name;?>" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="telephone"
                                            ...
                                            placeholder="Input Telephone Supplier" value="<?php echo $telephone;?>" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="address"
                                            ...
                                            placeholder="Input Address Supplier" value="<?php echo $address;?>" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                        ...
                        <a href="suppliers.php" class="btn btn-light-secondary me-1 mb-1" role="button" aria-pressed="true">Cancel</a>
