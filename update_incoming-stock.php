<?php 
    ...
    //$id = $_SESSION['id'];
    $sSQL="";
    $sSQL="SELECT tb_item.id AS id_item, tb_supplier.id AS id_supplier, tb_category.id AS id_category, tb_incoming_stock.id, 
        tb_item.name, tb_supplier.name AS supplier, tb_category.category, tb_incoming_stock.date, 
        ...
        WHERE tb_incoming_stock.id = '$id' limit 1";
    ...
    if( isset($_POST["update"]))
    {
        ...
        if(update_incoming_stock($_POST) > 0)
        {
            echo "
                <script>
                    alert('Incoming stock berhasil diubah!');
                    document.location.href = 'incoming-stock.php';
                </script>
            ";
        }
        else
        {
            echo "
                <script>
                    alert('Incoming stock gagal diubah!');
                </script>
            ";
        }
    }
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Update Incoming Stock</h3>
                        <p class="text-subtitle text-muted">For user to update incoming stock</p>
                    </div>
            ...
            <section class="section">
                <div class="card">
                    <form class="form form-vertical" action="" method="post">
                        ...
                        <a href="incoming-stock.php" class="btn btn-light-secondary me-1 mb-1" role="button" aria-pressed="true">Cancel</a>
