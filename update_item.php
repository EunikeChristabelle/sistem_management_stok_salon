<?php 
    ...
    $id=$_GET['id'];
    $result=mysqli_query($conn, "SELECT tb_item.name, tb_item.description, tb_category.category, tb_item.category
        AS id_category FROM tb_item INNER JOIN tb_category ON tb_item.category = tb_category.id WHERE tb_item.id='$id' limit 1");
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Update Item</h3>
                        <p class="text-subtitle text-muted">For user to update item</p>
                    </div>
            ...
            <section class="section">
                <div class="card">
                    <form class="form form-vertical" action="" method="post">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name"
                                        ...
                                        placeholder="Input Item Name" value="<?php echo $name;?>" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select id="category" class="form-control" name="category">
                                        <option value="<?=$id_category;?>" selected><?php echo $category;?></option>
                                        <?php
                                            $sSQL="";
                        ...
                        <a href="item-list.php" class="btn btn-light-secondary me-1 mb-1" role="button" aria-pressed="true">Cancel</a>
