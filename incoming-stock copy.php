            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <button type="Add" class="btn btn-primary me-1 mb-1" data-bs-toggle="modal"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="amount" class="form-control"
                                                            name="amount" placeholder="Input Amount" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                    ...
                    <table class="table table-striped" id="table1" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="4%">
                                    <a href="update_incoming-stock.php?id=<?php echo $row["id"] ?>"><button
